...
mfcurve <- function(data, outcome, factors, test = "mean", alpha = 0.05, showTitle = TRUE, SaveProcessedData = FALSE) {
...
###Testing
plottest <- mfcurve(df, outcome = "wage", factors = c("race", "south", "union"), SaveProcessedData = TRUE)
